...
public class FlightControllerImpl implements FlightController{
    ...
    @Override
    public ResponseEntity<ResponseGetAllFlights> getAllFlightsByDepartureCity(@PathVariable String departureCity) {
        return ResponseEntity.status(HttpStatus.OK).body(flightService.getAllFlightsByDepartureCity(departureCity));
    }
    ...
    public ResponseEntity<DepartureAndArrivalFlights> getDepartureAndComeBackFlights(@PathVariable String departureCity,
                                                                                           @PathVariable
                                                                                           @DateTimeFormat(pattern = "dd.MM.yyyy")LocalDate departureTime,
                                                                                           @PathVariable String arrivalCity,
                                                                                           @PathVariable
                                                                                           @DateTimeFormat(pattern = "dd.MM.yyyy")LocalDate comeBackTime) {
